  ...
  NamespaceInfo retrieveNamespaceInfo() throws IOException {
    ...
    while (shouldRun()) {
      try {
        /***
         * journalnode个数的选择
         * 如果集群在100个节点一下，我建议journlanode的个数3个就可以。
         * 如果在100到1000之间，5个就可以。换句话说我认为一个集群里面有7个journalnode就不正常。
         ...
         *      hadoop3(a),hadoop4(s)  BlookPollid
         *
         *  正常情况下，如果没有什么特殊的操作，集群在低于1000个节点的时候，我们就不用联邦。用HA架构就可以了。
         *
         *  5000个节点的集群：5个HA架构
         *                 10个namenode
         *
